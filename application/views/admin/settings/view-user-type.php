		...
		<div class="col-lg-8">
   		...
   		<div class="row">
				<div class="col-4 pb-3">
					<button type="button" class="btn btn-sm font-12 btn-default rounded-0 border" id="loadSidePage" data-link="get-user-type-frm" data-title="ADD USER TYPE" data-id="" ><i class="fas fa-user-plus"></i> Add User Type</button>
				</div>
			</div>
			<table class="table table-sm font-12" id="tbl-user-types-settings">
				<thead>
					<tr>
						<th>USER TYPE</th>
						<th>FR MOD</th>
