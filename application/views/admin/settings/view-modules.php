		...
		<div class="col-lg-8">
   		...
   		<div class="row">
				<div class="col-4 pb-3">
					<button type="button" class="btn btn-sm font-12 btn-default rounded-0 border" id="loadSidePage" data-link="get-module-frm" data-title="ADD MODULE" data-id="" ><i class="fas fa-user-plus"></i> Add Module</button>
				</div>
			</div>
			
			<table class="table table-sm font-12" id="tbl-modules-settings">
				<thead>
					<tr>
						<th>MODULE GROUP</th>
						<th>MODULE</th>
